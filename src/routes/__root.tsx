...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AtendAI — Atendente de WhatsApp com IA + CRM Kanban" },
      { name: "description", content: "Conecte o WhatsApp, deixe a IA atender e organize seus leads em um kanban arrastável." },
      { name: "author", content: "AtendAI" },
      { property: "og:title", content: "AtendAI — Atendente de WhatsApp com IA + CRM Kanban" },
      ...
      { name: "twitter:title", content: "AtendAI — Atendente de WhatsApp com IA + CRM Kanban" },
