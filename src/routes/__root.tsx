...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AtendZap — Atendente de WhatsApp com IA + CRM Kanban" },
      ...
      { property: "og:title", content: "AtendZap — Atendente de WhatsApp com IA + CRM Kanban" },
      ...
      { name: "twitter:title", content: "AtendZap — Atendente de WhatsApp com IA + CRM Kanban" },
